...
<template>
  <div class="w-full bg-[#e5dad8]">
    <Carousel v-bind="carouselConfig" class="w-full">
      <Slide v-for="slide in 10" :key="slide">
        <div class="carousel__item h-[400px]">
          ...
          <Carousel v-bind="bookList" class="w-[1200px]">
            <Slide v-for="book in books" :key="book._id">
              <div class="carousel__item h-full w-full">
                <div class="p-3 h-full shadow-2xl border border-base-300 bg-white rounded-lg transition duration-500">
