...
const navItemClasses =
  'px-2 text-gray-500 hover:text-gray-800 transition-color duration-200 min-h-[68px] max-h-[68px] flex items-center justify-center'
const activeItemClasses = 'menu-active'
</script>
<template>
  <div class="bg-base-100 fixed top-0 right-0 left-0 z-10">
    ...
    <div
      class="navbar z-10 mx-auto max-h-[68px] min-h-[68px] max-w-[1200px] px-0"
    >
      ...
      <ul class="menu menu-horizontal navbar-center gap-2">
        <RouterLink to="/home">
          <li>
        ...
        <RouterLink to="/borrowing-history">
          <li>
            <span
              :class="[
                { [activeItemClasses]: route.path === '/borrowing-history' }
              ]"
            >
              Lịch sử mượn sách
            </span>
      ...
      <div class="navbar-end">
        ...
        <div v-else class="dropdown dropdown-end ml-4">
          <div
            tabindex="0"
            role="button"
            class="flex cursor-pointer flex-col items-center gap-1 select-none"
          >
            ...
            <div class="text-xs whitespace-nowrap">
              {{ currentActiveUser?.hoLot + ' ' + currentActiveUser?.ten }}
            </div>
          </div>
          <ul
            tabindex="0"
